...
public class Ejer3_12<E> {
	...
	public static Ejer3_12<Integer> getTLinkedList() {
		Ejer3_12<Integer> l = new Ejer3_12<Integer>();
		l.addFirst(42);
		l.addFirst(5);
		l.addFirst(4);
		l.addFirst(3);
	...
	public static void oldTest() throws Illegal, Empty {
		...
		System.out.println("Terminado con las pruebas de Ejer3_12.");
	}
}