public class Ejer3_16 {
     ...
     */
    public Ejer3_16 reversa() {
        // Aquí va su código.
        Ejer3_16 rev=new Ejer3_16();
        Nodo n=cola;
        for(int i=1;i<=getLongitud();i++){
     ...
     */
    public Ejer3_16 copia() {
        Ejer3_16 l=new Ejer3_16();
        Nodo n=cabeza;
        for(int i=1;i<=getLongitud();i++){
          l.agregaFinal(n.get());
          n=n.siguiente;
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof Ejer3_16))
            return false;
            Ejer3_16 lista = (Ejer3_16)o;
